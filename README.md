# 420rom Kernel Tree for Samsung Note10 devices

Based on samsung sources and android common tree.
Supported devices: N970F, N975F, N976B.

## Contributors

- abun880007 - 420rom config and maintainer
...
Reboot to TWRP. Flash 420rom.zip. Reboot to system.
...
First of all, you need to edit model argument (by default it's N976B) to the model
of your phone. You can select multiple models. Supported models are:  N970F, N971N, N975F, N976B.
...
You can change the name of the kernel by replacing ```name="420rom-v11.0"``` with,
...
# Compile kernel for N970F, N975F, N976B phones.
# Use model=all if you want to build the kernel for all available phones.
$ ./cruelbuild mkimg name="Custom420rom" model=N976B,N970F,N975F toolchain=proton +magisk=canary +wireguard +ttl +cifs +nohardening
...
# FLASH=y ./cruelbuild mkimg name="CustomCruel" model=N976B toolchain=default +magisk=canary +wireguard +ttl +cifs +nohardening
```
